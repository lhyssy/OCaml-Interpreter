...
while_start_11:
	mul t1, t0, t0
	blt a0, t1, while_end_13
	rem t1, a0, t0
	addi t2, x0, 0
	sub t1, t1, t2
	sub t1, t1, x0
	sltiu t1, t1, 1
	bne t1, x0, or_true_16
	addi t1, x0, 2
	add t1, t0, t1
	rem t1, a0, t1
	bne t1, x0, else_14
...
complexFunction:
	...
	slt t1, a1, a0
	slt t2, a2, a1
	beq t1, x0, and_false_32
	beq t2, x0, and_false_32
	addi t2, x0, 1
	jal x0, and_end_33
and_false_32:
	addi t2, x0, 0
...
else_34:
	...
	sub t1, t1, x0
	sltiu t1, t1, 1
	beq t2, x0, and_false_40
	beq t1, x0, and_false_40
	addi t1, x0, 1
	jal x0, and_end_41
and_false_40:
	addi t1, x0, 0
and_end_41:
	bne t1, x0, or_true_39
	blt a2, a1, else_37
or_true_39:
	mul t1, a1, a0
	addi t2, x0, -3
...
else_42:
	...
	sub t2, t2, x0
	sltu t2, x0, t2
	bne t1, x0, or_true_47
	bne t2, x0, or_true_47
	addi t2, x0, 0
	jal x0, or_end_48
or_true_47:
	addi t2, x0, 1
...
nestedLoopsAndConditions:
	...
	addi t1, x0, 0
while_start_65:
	bge t1, a0, while_end_67
	addi t2, x0, 0
while_start_68:
	bge t2, t1, while_end_70
	add t3, t1, t2
	addi t4, x0, 2
	rem t3, t3, t4
	bne t3, x0, else_71
